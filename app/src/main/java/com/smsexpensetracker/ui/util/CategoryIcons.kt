...
val CATEGORY_ICONS: List<IconEntry> = listOf(
    ...
    IconEntry("checkout", listOf("checkout", "pay", "buy"), Icons.Filled.ShoppingCart),
    ...
    IconEntry("mask", listOf("mask", "health", "face"), Icons.Filled.MedicalServices),
    ...
    IconEntry("paw", listOf("paw", "animal", "pet"), Icons.Filled.Pets),
    ...
    IconEntry("microphone", listOf("mic", "audio", "music"), Icons.Filled.Headphones),
    ...
    IconEntry("monitoring", listOf("monitor", "chart", "stats"), Icons.Filled.ShowChart),
